...
//DELETE GAME
router.delete("/games/:gameId", authenticateToken, isAdmin(), async (req: Request, res: Response) => {
  await adminController.deleteGame(req, res);
});

//TERMINATE GAME
router.patch("/games/:gameId/terminate", authenticateToken, isAdmin(), async (req: Request, res: Response) => {
