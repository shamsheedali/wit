const TYPES = {
  ...
  GameReportModel: Symbol.for('GameReportModel'),
  //Repositories
  ...
  GameReportRepository: Symbol.for('GameReportRepository'),
  //Services
  ...
  GameReportService: Symbol.for('GameReportService'),
  //Controllers
  ...
  GameReportController: Symbol.for('GameReportController'),
};
